...
<head>
  ...
  <title>Fidak (BBMS) - User Queries</title>
      ...
      <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              <div class="col-md-6">
                <h5 class="mb-0">All Contact Queries</h5>
              </div>
              <div class="col-md-6 text-right">
                <?php
                $pending_sql = "SELECT COUNT(*) as pending FROM contact_query WHERE query_status = 2";
          ...
          <div class="card-body">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo substr($row['query_message'], 0, 30) . '...'; ?></td>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <p><?php echo $row['query_message']; ?></p>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                              <?php if($row['query_status'] == 2) { ?>
                                <a href="query.php?id=<?php echo $row['query_id'];?>" class="btn btn-primary">
                                  Mark as Read
                                </a>
                              <?php } ?>
                            </div>
            ...
            <?php 
            $total_sql = "SELECT COUNT(*) as total FROM contact_query";
            ...
            <nav aria-label="Page navigation">
              <ul class="pagination">
                <?php if($page > 1) { ?>
                <li class="page-item">
                  <a class="page-link" href="query.php?page=<?php echo $page-1; ?>" aria-label="Previous">
                ...
                <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                  <a class="page-link" href="query.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
                <?php } ?>
                
                <?php if($total_page > $page) { ?>
                <li class="page-item">
                  <a class="page-link" href="query.php?page=<?php echo $page+1; ?>" aria-label="Next">
            ...
            <div class="alert alert-info text-center">
              <i class="fas fa-info-circle"></i> No queries found.
            </div>
            <?php } ?>
          </div>
        </div>
